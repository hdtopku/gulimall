...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        GeneratorConfig config = GeneratorConfig.builder().jdbcUrl("jdbc:mysql://121.41.170.120/gulimall_pms?autoReconnect=true&useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=Asia/Shanghai")
                .userName("root")
                .password(password)
