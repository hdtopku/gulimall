...
public class UndoLogController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("sms:undolog:list")
    ...
    @RequiresPermissions("sms:undolog:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("sms:undolog:save")
    ...
    @RequiresPermissions("sms:undolog:update")
    ...
    @RequiresPermissions("sms:undolog:delete")
